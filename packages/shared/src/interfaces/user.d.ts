...
export interface GetUserAPIResponse extends Omit<UserDocument, 'orders_placed' | 'orders_taken' | 'journeys_shared' | 'journeys_joined'> {
...
export interface HistoryAPIResponse extends ResponseWithPagination<JourneyDocument | DeliveryOrderDocument> {
}
